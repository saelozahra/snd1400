...
Sub Activity_Create(FirstTime As Boolean)
	...
	SaeloZahra.SetToolbarStyle(ToolBar,"پویــــــش ها",True,ScrollView1)
...
Sub LoadMsgs
	...
	cu1 = sql1.ExecQuery("SELECT * FROM notification WHERE type='notification' ORDER BY id DESC limit 110")
