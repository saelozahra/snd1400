...
Sub Activity_Create(FirstTime As Boolean)
	Try
		...
		ToolBar.subTitleTextColor=SaeloZahra.ColorLightTransparent
		ToolBar.subTitle=SaeloZahra.CSB("موقعیت خود را برای یافتن نزدیک‌ترین شعبه انتخاب کنید")
		
		SaeloZahra.SetToolbarStyle(ToolBar,"موقعیت مکانی",True,Panel1)
		SelectLocationBTN.SetLayout(SelectLocationBTN.Left,SelectLocationBTN.Top-SaeloZahra.StatusBarHeight,SelectLocationBTN.Width,SelectLocationBTN.Height)
		...
		Activity.Title = SaeloZahra.CSBTitle("موقعیت مکانی خود را انتخاب کنید")
		...
		SelectLocationBTN.TextColor=SaeloZahra.ColorDark
