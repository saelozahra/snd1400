...
public class main extends com.onboarder.AhoyOnboarderActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.saelozahra.banooyar", "ir.saelozahra.banooyar.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.saelozahra.banooyar", "ir.saelozahra.banooyar.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.saelozahra.banooyar.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
vis = vis | (contentlistact.mostCurrent != null);
vis = vis | (electionact.mostCurrent != null);
vis = vis | (notificationact.mostCurrent != null);
vis = vis | (mapact.mostCurrent != null);
vis = vis | (translateact.mostCurrent != null);
...
_p.Initialize(mostCurrent.activityBA,"p");
 //BA.debugLineNum = 52;BA.debugLine="l.Add(c.AddCard(\"بانویار\" , \"راهنمای بانوان\"&CRLF";
_l.Add((Object)(_c.AddCard("بانویار","راهنمای بانوان"+anywheresoftware.b4a.keywords.Common.CRLF+"در سفر اربعین","wallet")));
...
_c.setDescriptionTextSize(_p.dpToPixels((int) (8)));
 //BA.debugLineNum = 59;BA.debugLine="l.Add(c1.AddCard(\"مشاوره\",\"دریافت هرگونه مشاوره ب";
_l.Add((Object)(_c1.AddCard("مشاوره","دریافت هرگونه مشاوره با متخصصین مجرب در حوزه بانوران","chalk")));
...
_c1.setDescriptionTextSize(_p.dpToPixels((int) (8)));
 //BA.debugLineNum = 66;BA.debugLine="l.Add(c2.AddCard(\"چند زبانه\",\"این اپلیکیشن با زبا";
_l.Add((Object)(_c2.AddCard("چند زبانه","این اپلیکیشن با زبان های"+anywheresoftware.b4a.keywords.Common.CRLF+"فارسی | عربی و انگلیسی "+anywheresoftware.b4a.keywords.Common.CRLF+" در دسترس است","blindpng")));
...
_openappcounter();
 //BA.debugLineNum = 84;BA.debugLine="File.Copy(File.DirAssets,\"db.db\",SaeloZahra.dir,\"";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 120;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 121;BA.debugLine="DTTC.TapToClose";
...
public static String  _openappcounter() throws Exception{
 //BA.debugLineNum = 95;BA.debugLine="Sub OpenAppCounter";
 //BA.debugLineNum = 97;BA.debugLine="If File.Exists(SaeloZahra.Dir,\"AppOpenCount\") The";
if (anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._saelozahra._dir /*String*/ ,"AppOpenCount")) { 
 //BA.debugLineNum = 98;BA.debugLine="AppOpenCount = File.ReadString(SaeloZahra.Dir,\"A";
_appopencount = (int)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.File.ReadString(mostCurrent._saelozahra._dir /*String*/ ,"AppOpenCount")));
 ...
 //BA.debugLineNum = 101;BA.debugLine="File.WriteString(SaeloZahra.Dir,\"AppOpenCount\",Ap";
anywheresoftware.b4a.keywords.Common.File.WriteString(mostCurrent._saelozahra._dir /*String*/ ,"AppOpenCount",BA.NumberToString(_appopencount+1));
 //BA.debugLineNum = 103;BA.debugLine="Log(\"AppOpenCount: \"&AppOpenCount)";
anywheresoftware.b4a.keywords.Common.LogImpl("4262152","AppOpenCount: "+BA.NumberToString(_appopencount),0);
 //BA.debugLineNum = 109;BA.debugLine="End Sub";
return "";
}
public static String  _p_onfinishbuttonpressed() throws Exception{
 //BA.debugLineNum = 88;BA.debugLine="Sub p_onFinishButtonPressed";
 //BA.debugLineNum = 89;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 90;BA.debugLine="SaeloZahra.SetAnimation(\"zoom_exit\",\"zoom_enter\")";
mostCurrent._saelozahra._setanimation /*String*/ (mostCurrent.activityBA,"zoom_exit","zoom_enter");
 //BA.debugLineNum = 91;BA.debugLine="Show.convertActivityFromTranslucent";
mostCurrent._show.convertActivityFromTranslucent(mostCurrent.activityBA);
 //BA.debugLineNum = 92;BA.debugLine="StartActivity(TranslateAct)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._translateact.getObject()));
