...
public class qrgenerator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.saelozahra.banooyar.qrgenerator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.saelozahra.banooyar.qrgenerator.class).invoke(this, new Object[] {null});
        else
...
public ir.saelozahra.banooyar.b4xbytesbuilder _tempbb = null;
...
public String  _adddatatomatrix(byte[] _encoded,ir.saelozahra.banooyar.qrgenerator._qrversiondata _vd) throws Exception{
byte[] _format = null;
...
public String  _addfinders(ir.saelozahra.banooyar.qrgenerator._qrversiondata _vd) throws Exception{
int _x = 0;
int _y = 0;
int _i = 0;
...
_tempbb = new ir.saelozahra.banooyar.b4xbytesbuilder();
...
byte[] _bytes = null;
ir.saelozahra.banooyar.qrgenerator._qrversiondata _vd = null;
ir.saelozahra.banooyar.qrgenerator._qrversiondata _version = null;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
byte[] _mode = null;
byte[] _contentcountindicator = null;
ir.saelozahra.banooyar.b4xbytesbuilder _encodeddata = null;
byte _b = (byte)0;
int _padsize = 0;
byte[] _pad = null;
...
_vd = new ir.saelozahra.banooyar.qrgenerator._qrversiondata();
...
;
for (; index3 < groupLen3;index3++){
_version = (ir.saelozahra.banooyar.qrgenerator._qrversiondata)(group3.Get(index3));
...
__c.LogImpl("49175051","Too long!",0);
...
__c.LogImpl("49175054",_vd.VersionName /*String*/ +", Size: "+BA.NumberToString(_bytes.length),0);
...
_encodeddata = new ir.saelozahra.banooyar.b4xbytesbuilder();
...
_encodeddata._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (_mode);
 //BA.debugLineNum = 166;BA.debugLine="EncodedData.Append(ContentCountIndicator)";
_encodeddata._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (_contentcountindicator);
...
_encodeddata._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (_unsignedbytetobits(__c.Bit.And((int) (0xff),(int) (_b))));
 }
};
...
_encodeddata._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (_pad);
...
_encodeddata._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (new byte[]{(byte) (0)});
 }
;
...
_encodeddata._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (new byte[]{(byte) (1),(byte) (1),(byte) (1),(byte) (0),(byte) (1),(byte) (1),(byte) (0),(byte) (0)});
...
_encodeddata._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (new byte[]{(byte) (0),(byte) (0),(byte) (0),(byte) (1),(byte) (0),(byte) (0),(byte) (0),(byte) (1)});};
 }
;
...
public ir.saelozahra.banooyar.qrgenerator._qrversiondata  _createversiondata(int _version,String _name,int[] _generator,byte[] _format,int _maxsize,int _maxusablesize,int[] _alignments,int _group1size,int _group2size,int _block1size,int _block2size,byte[] _versioninformation) throws Exception{
ir.saelozahra.banooyar.qrgenerator._qrversiondata _v = null;
...
_v = new ir.saelozahra.banooyar.qrgenerator._qrversiondata();
...
_tempbb._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (new byte[]{(byte) (1)});
 }else {
 //BA.debugLineNum = 360;BA.debugLine="TempBB.Append(Array As Byte(0))";
_tempbb._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (new byte[]{(byte) (0)});
 };
 }
};
...
public String  _versionwithtwogroups(int[] _generator,int _group1size,int _group2size,int _block1size,int _block2size,ir.saelozahra.banooyar.b4xbytesbuilder _encodeddata) throws Exception{
...
int[] _ec = null;
int[] _ec2 = null;
ir.saelozahra.banooyar.b4xbytesbuilder _interleaved = null;
int[] _ii = null;
...
_interleaved = new ir.saelozahra.banooyar.b4xbytesbuilder();
...
_interleaved._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (_unsignedbytetobits(_ii[_i]));
 };
 }
};
 }
...
_encodeddata._append /*ir.saelozahra.banooyar.b4xbytesbuilder*/ (_interleaved._toarray /*byte[]*/ ());
