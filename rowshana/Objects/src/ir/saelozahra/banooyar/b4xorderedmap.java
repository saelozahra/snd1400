...
public class b4xorderedmap extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.saelozahra.banooyar.b4xorderedmap");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.saelozahra.banooyar.b4xorderedmap.class).invoke(this, new Object[] {null});
        else
