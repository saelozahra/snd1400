...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ir.saelozahra.banooyar", "ir.saelozahra.banooyar.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.saelozahra.banooyar.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
anywheresoftware.b4a.keywords.Common.LogImpl("412255234",_job._jobname /*String*/ +"  "+BA.ObjectToString(_job._success /*boolean*/ ),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("412255260","Error: "+_job._errormessage /*String*/ ,0);
