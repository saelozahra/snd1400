...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.saelozahra.banooyar.b4xbytesbuilder");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.saelozahra.banooyar.b4xbytesbuilder.class).invoke(this, new Object[] {null});
        else
...
public ir.saelozahra.banooyar.b4xbytesbuilder  _append(byte[] _data) throws Exception{
int _oldlength = 0;
...
if (true) return (ir.saelozahra.banooyar.b4xbytesbuilder)(this);
 //BA.debugLineNum = 28;BA.debugLine="End Sub";
return null;
}
public ir.saelozahra.banooyar.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
if (_index>_mlength) { 
__c.LogImpl("913107202","Index too large",0);};
...
if (_index>_mlength) { 
__c.LogImpl("913172738","Index too large",0);};
