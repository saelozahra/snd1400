...
public class selectmapact extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.saelozahra.banooyar", "ir.saelozahra.banooyar.selectmapact");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.saelozahra.banooyar", "ir.saelozahra.banooyar.selectmapact");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.saelozahra.banooyar.selectmapact", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public ir.saelozahra.banooyar.doubletaptoclose _dttc = null;
public ir.saelozahra.banooyar.httpjob _get_my_address = null;
...
anywheresoftware.b4a.keywords.Common.LogImpl("410747958",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
public ResumableSub_Activity_Resume(ir.saelozahra.banooyar.selectmapact parent) {
this.parent = parent;
}
ir.saelozahra.banooyar.selectmapact parent;
String _permission = "";
...
anywheresoftware.b4a.keywords.Common.LogImpl("410813454",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
mostCurrent._dttc = new ir.saelozahra.banooyar.doubletaptoclose();
 //BA.debugLineNum = 25;BA.debugLine="Dim get_my_address As HttpJob";
mostCurrent._get_my_address = new ir.saelozahra.banooyar.httpjob();
...
anywheresoftware.b4a.keywords.Common.LogImpl("410944518","Go To My Location",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("410944531",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 174;BA.debugLine="End Sub";
return "";
}
public static String  _jobdone(ir.saelozahra.banooyar.httpjob _job) throws Exception{
 //BA.debugLineNum = 302;BA.debugLine="Sub JobDone(Job As HttpJob)";
 //BA.debugLineNum = 303;BA.debugLine="Log(Job.JobName&\" | \"&Job.Success)";
anywheresoftware.b4a.keywords.Common.LogImpl("411403265",_job._jobname /*String*/ +" | "+BA.ObjectToString(_job._success /*boolean*/ ),0);
...
public ResumableSub_MapFragment1_CameraChange(ir.saelozahra.banooyar.selectmapact parent,anywheresoftware.b4a.objects.MapFragmentWrapper.CameraPositionWrapper _position) {
this.parent = parent;
...
anywheresoftware.b4a.keywords.Common.LogImpl("411206668","https://us1.locationiq.com/v1/reverse.php?key=50f886904c60e7&lat="+BA.NumberToString(_position.getTarget().getLatitude())+"&lon="+BA.NumberToString(_position.getTarget().getLongitude())+"&accept-language=fa&format=json",anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("411206681",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
public ResumableSub_MapFragment1_Ready(ir.saelozahra.banooyar.selectmapact parent) {
this.parent = parent;
}
ir.saelozahra.banooyar.selectmapact parent;
String _permission = "";
...
anywheresoftware.b4a.keywords.Common.LogImpl("411272195","map ready",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("411272205","No permission!",0);
 if (true) break;
;
...
anywheresoftware.b4a.keywords.Common.LogImpl("411272217","Go To My Location",0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("411272242",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("411468821",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
