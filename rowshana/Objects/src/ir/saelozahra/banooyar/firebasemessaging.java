...
public class firebasemessaging extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ir.saelozahra.banooyar", "ir.saelozahra.banooyar.firebasemessaging");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.saelozahra.banooyar.firebasemessaging", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
anywheresoftware.b4a.keywords.Common.LogImpl("43735554","Message arrived",0);
 //BA.debugLineNum = 73;BA.debugLine="Log(\"Message data: \"&Message.GetData)";
anywheresoftware.b4a.keywords.Common.LogImpl("43735555","Message data: "+BA.ObjectToString(_message.GetData()),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("43735591",_msg_title+"  :  "+_msg_type+"  :  "+_msg_body,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("43670017","Token: "+_token,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("43801093","Inserted",0);
 } 
       catch (Exception e5) {
			processBA.setLastException(e5); //BA.debugLineNum = 124;BA.debugLine="Log($\" ${LastException.Message} error to insert";
anywheresoftware.b4a.keywords.Common.LogImpl("43801095",(" "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.LastException(processBA).getMessage()))+" error to insert this id to notification = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_msg_title))+""),0);
 };
...
public ResumableSub_Service_Start(ir.saelozahra.banooyar.firebasemessaging parent,anywheresoftware.b4a.objects.IntentWrapper _startingintent) {
this.parent = parent;
this._startingintent = _startingintent;
}
ir.saelozahra.banooyar.firebasemessaging parent;
...
public ResumableSub_SubscribeToTopics(ir.saelozahra.banooyar.firebasemessaging parent,String _topicname) {
this.parent = parent;
...
anywheresoftware.b4a.keywords.Common.LogImpl("43538956","adding topic "+_topicname,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("43538958","error1: "+anywheresoftware.b4a.keywords.Common.LastException(processBA).getMessage(),0);
