...
anywheresoftware.b4a.objects.drawable.ColorDrawable _cd2 = null;
 //BA.debugLineNum = 217;BA.debugLine="Sub CD( Color1 As Int ) As ColorDrawable";
 //BA.debugLineNum = 218;BA.debugLine="Dim cd2 As ColorDrawable";
_cd2 = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 219;BA.debugLine="cd2.Initialize2(Color1,12dip,1dip,ColorLight)";
_cd2.Initialize2(_color1,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)),_colorlight);
 //BA.debugLineNum = 220;BA.debugLine="Return cd2";
if (true) return _cd2;
...
anywheresoftware.b4j.object.JavaObject _style = null;
 //BA.debugLineNum = 675;BA.debugLine="Sub ChangeGooglemapStyle(StyleCode As String,Map A";
 //BA.debugLineNum = 676;BA.debugLine="Dim JO As JavaObject = Map";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_map.getObject()));
 //BA.debugLineNum = 677;BA.debugLine="Dim Style As JavaObject";
_style = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 678;BA.debugLine="Style.InitializeNewInstance(\"com.google.android.g";
_style.InitializeNewInstance("com.google.android.gms.maps.model.MapStyleOptions",new Object[]{(Object)(_stylecode)});
 //BA.debugLineNum = 679;BA.debugLine="Return JO.RunMethod(\"setMapStyle\", Array(Style))";
...
public static boolean  _checkconnection(anywheresoftware.b4a.BA _ba) throws Exception{
 //BA.debugLineNum = 622;BA.debugLine="Sub CheckConnection As Boolean";
 //BA.debugLineNum = 624;BA.debugLine="If (p.GetDataState == \"CONNECTED\") Or (p.GetSetti";
...
int _resultstep3 = 0;
int _ic = 0;
 //BA.debugLineNum = 58;BA.debugLine="Sub CheckMelliCode(MelliCode As String)As Boolean";
 //BA.debugLineNum = 59;BA.debugLine="Dim b As Boolean";
_b = false;
 //BA.debugLineNum = 60;BA.debugLine="Dim sCodePosition(10) As String";
_scodeposition = new String[(int) (10)];
java.util.Arrays.fill(_scodeposition,"");
 //BA.debugLineNum = 61;BA.debugLine="Dim iCodePosition(10) As String";
_icodeposition = new String[(int) (10)];
java.util.Arrays.fill(_icodeposition,"");
 //BA.debugLineNum = 63;BA.debugLine="Dim resultStep1,resultStep2,resultStep3 As Int";
_resultstep1 = 0;
_resultstep2 = 0;
_resultstep3 = 0;
 //BA.debugLineNum = 65;BA.debugLine="If MelliCode.Length = 10 Then";
if (_mellicode.length()==10) { 
 //BA.debugLineNum = 67;BA.debugLine="For ic = 0 To 9";
{
final int step6 = 1;
final int limit6 = (int) (9);
_ic = (int) (0) ;
for (;_ic <= limit6 ;_ic = _ic + step6 ) {
 //BA.debugLineNum = 68;BA.debugLine="sCodePosition(ic) = MelliCode.CharAt(ic)";
_scodeposition[_ic] = BA.ObjectToString(_mellicode.charAt(_ic));
 //BA.debugLineNum = 69;BA.debugLine="iCodePosition(ic) = sCodePosition(ic)";
_icodeposition[_ic] = _scodeposition[_ic];
 }
};
 //BA.debugLineNum = 72;BA.debugLine="resultStep1 = (iCodePosition(0)*10)+(iCodePositi";
_resultstep1 = (int) (((double)(Double.parseDouble(_icodeposition[(int) (0)]))*10)+((double)(Double.parseDouble(_icodeposition[(int) (1)]))*9)+((double)(Double.parseDouble(_icodeposition[(int) (2)]))*8)+((double)(Double.parseDouble(_icodeposition[(int) (3)]))*7)+((double)(Double.parseDouble(_icodeposition[(int) (4)]))*6)+((double)(Double.parseDouble(_icodeposition[(int) (5)]))*5)+((double)(Double.parseDouble(_icodeposition[(int) (6)]))*4)+((double)(Double.parseDouble(_icodeposition[(int) (7)]))*3)+((double)(Double.parseDouble(_icodeposition[(int) (8)]))*2));
 //BA.debugLineNum = 73;BA.debugLine="resultStep2 = (resultStep1 Mod 11)";
_resultstep2 = (int) ((_resultstep1%11));
 //BA.debugLineNum = 74;BA.debugLine="resultStep3 = 11 - resultStep2";
_resultstep3 = (int) (11-_resultstep2);
 //BA.debugLineNum = 75;BA.debugLine="If resultStep2 < 2 Then";
if (_resultstep2<2) { 
 //BA.debugLineNum = 76;BA.debugLine="If resultStep2 = iCodePosition(9) Then";
if (_resultstep2==(double)(Double.parseDouble(_icodeposition[(int) (9)]))) { 
 //BA.debugLineNum = 77;BA.debugLine="b = True";
_b = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 78;BA.debugLine="Return b";
if (true) return _b;
 }else {
 //BA.debugLineNum = 80;BA.debugLine="b = False";
_b = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 81;BA.debugLine="Return b";
if (true) return _b;
 };
 }else {
 //BA.debugLineNum = 84;BA.debugLine="If resultStep3 = iCodePosition(9) Then";
if (_resultstep3==(double)(Double.parseDouble(_icodeposition[(int) (9)]))) { 
 //BA.debugLineNum = 85;BA.debugLine="b = True";
_b = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 86;BA.debugLine="Return b";
if (true) return _b;
 }else {
 //BA.debugLineNum = 88;BA.debugLine="b = False";
_b = anywheresoftware.b4a.keywords.Common.False;
...
if (true) return _b;
 ...
 //BA.debugLineNum = 93;BA.debugLine="b = False";
_b = anywheresoftware.b4a.keywords.Common.False;
...
anywheresoftware.b4a.keywords.StringBuilderWrapper _sb = null;
 //BA.debugLineNum = 644;BA.debugLine="Sub CheckSite As Boolean";
 //BA.debugLineNum = 645;BA.debugLine="Dim sb As StringBuilder";
_sb = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 646;BA.debugLine="sb.Initialize";
_sb.Initialize();
 //BA.debugLineNum = 647;BA.debugLine="p.Shell(\"ping -c 2 -W 10 -v google.com\", Null, sb";
_p.Shell("ping -c 2 -W 10 -v google.com",(String[])(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(_sb.getObject()),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 648;BA.debugLine="If sb.Length = 0 Then";
if (_sb.getLength()==0) { 
 //BA.debugLineNum = 649;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 }else {
...
public static String  _convertenglish(anywheresoftware.b4a.BA _ba,String _text) throws Exception{
 //BA.debugLineNum = 252;BA.debugLine="Sub ConvertEnglish( Text As String ) As String";
 //BA.debugLineNum = 253;BA.debugLine="Return Text.Replace( \"۰\" , \"0\" ).Replace( \"۱\" , \"";
...
public static String  _convertpersian(anywheresoftware.b4a.BA _ba,String _text) throws Exception{
 //BA.debugLineNum = 248;BA.debugLine="Sub ConvertPersian( Text As String ) As String";
 //BA.debugLineNum = 249;BA.debugLine="Return Text.Replace( \"0\" , \"۰\" ).Replace( \"1\" , \"";
...
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 657;BA.debugLine="Sub CSB(text As String) As CSBuilder";
 //BA.debugLineNum = 658;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 659;BA.debugLine="CS.Initialize.Typeface(Font).Append(text).PopAll";
_cs.Initialize().Typeface((android.graphics.Typeface)(_font.getObject())).Append(BA.ObjectToCharSequence(_text)).PopAll();
 //BA.debugLineNum = 660;BA.debugLine="Return CS";
if (true) return _cs;
...
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 669;BA.debugLine="Sub CSBTitle(text As String) As CSBuilder";
 //BA.debugLineNum = 670;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 671;BA.debugLine="CS.Initialize.Typeface(fontBold).Append(text).Pop";
_cs.Initialize().Typeface((android.graphics.Typeface)(_fontbold.getObject())).Append(BA.ObjectToCharSequence(_text)).PopAll();
 //BA.debugLineNum = 672;BA.debugLine="Return CS";
if (true) return _cs;
...
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 663;BA.debugLine="Sub CSBWhite(text As String) As CSBuilder";
 //BA.debugLineNum = 664;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 665;BA.debugLine="CS.Initialize.Typeface(Font).Color(Colors.White).";
_cs.Initialize().Typeface((android.graphics.Typeface)(_font.getObject())).Color(anywheresoftware.b4a.keywords.Common.Colors.White).Size((int) (12)).Append(BA.ObjectToCharSequence(_text)).PopAll();
 //BA.debugLineNum = 666;BA.debugLine="Return CS";
if (true) return _cs;
...
public static String  _esmemah(anywheresoftware.b4a.BA _ba,int _input) throws Exception{
 //BA.debugLineNum = 257;BA.debugLine="Sub esmeMah(input As Int)As String";
 //BA.debugLineNum = 259;BA.debugLine="Select input";
switch (_input) {
case 1: {
 //BA.debugLineNum = 262;BA.debugLine="Return \"فروردین\"";
if (true) return "فروردین";
 break; }
case 2: {
 //BA.debugLineNum = 264;BA.debugLine="Return \"اردیبهشت\"";
if (true) return "اردیبهشت";
 break; }
case 3: {
 //BA.debugLineNum = 266;BA.debugLine="Return \"خرداد\"";
if (true) return "خرداد";
 break; }
case 4: {
 //BA.debugLineNum = 268;BA.debugLine="Return \"تیر\"";
if (true) return "تیر";
 break; }
case 5: {
 //BA.debugLineNum = 270;BA.debugLine="Return \"مرداد\"";
if (true) return "مرداد";
 break; }
case 6: {
 //BA.debugLineNum = 272;BA.debugLine="Return \"شهریور\"";
if (true) return "شهریور";
 break; }
case 7: {
 //BA.debugLineNum = 274;BA.debugLine="Return \"مهر\"";
if (true) return "مهر";
 break; }
case 8: {
 //BA.debugLineNum = 276;BA.debugLine="Return \"آبان\"";
if (true) return "آبان";
 break; }
case 9: {
 //BA.debugLineNum = 278;BA.debugLine="Return \"آذر\"";
if (true) return "آذر";
 break; }
case 10: {
 //BA.debugLineNum = 280;BA.debugLine="Return \"دی\"";
if (true) return "دی";
 break; }
case 11: {
 //BA.debugLineNum = 282;BA.debugLine="Return \"بهمن\"";
if (true) return "بهمن";
 break; }
case 12: {
 //BA.debugLineNum = 284;BA.debugLine="Return \"اسفند\"";
if (true) return "اسفند";
 break; }
default: {
 //BA.debugLineNum = 286;BA.debugLine="Return input";
...
public static String  _esmeroozehafte(anywheresoftware.b4a.BA _ba,long _timestamp) throws Exception{
 //BA.debugLineNum = 403;BA.debugLine="Sub esmeRoozeHafte(timestamp As Long) As String";
 //BA.debugLineNum = 408;BA.debugLine="If timestamp == 0 Then timestamp = DateTime.Now";
if (_timestamp==0) { 
_timestamp = anywheresoftware.b4a.keywords.Common.DateTime.getNow();};
 //BA.debugLineNum = 410;BA.debugLine="Select DateTime.GetDayOfWeek(timestamp)";
...
case 0: {
 //BA.debugLineNum = 412;BA.debugLine="Return \" شنبه \"";
if (true) return " شنبه ";
 break; }
case 1: {
 //BA.debugLineNum = 414;BA.debugLine="Return \" یکشنبه \"";
if (true) return " یکشنبه ";
 break; }
case 2: {
 //BA.debugLineNum = 416;BA.debugLine="Return \" دوشنبه \"";
if (true) return " دوشنبه ";
 break; }
case 3: {
 //BA.debugLineNum = 418;BA.debugLine="Return \" سه شنبه \"";
if (true) return " سه شنبه ";
 break; }
case 4: {
 //BA.debugLineNum = 420;BA.debugLine="Return \" چهارشنبه \"";
if (true) return " چهارشنبه ";
 break; }
case 5: {
 //BA.debugLineNum = 422;BA.debugLine="Return \" پنجشنبه \"";
if (true) return " پنجشنبه ";
 break; }
case 6: {
 //BA.debugLineNum = 424;BA.debugLine="Return \" جمعه \"";
if (true) return " جمعه ";
 break; }
default: {
 //BA.debugLineNum = 426;BA.debugLine="Return \" امروز \"";
...
int _delta = 0;
 //BA.debugLineNum = 534;BA.debugLine="Sub FitCenterBitmap( Imv As ImageView , bmp As Bit";
 //BA.debugLineNum = 537;BA.debugLine="Private cvs As Canvas";
_cvs = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 538;BA.debugLine="cvs.Initialize(Imv)";
_cvs.Initialize((android.view.View)(_imv.getObject()));
 //BA.debugLineNum = 540;BA.debugLine="Dim rectDest As Rect";
_rectdest = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 541;BA.debugLine="Dim delta As Int";
_delta = 0;
 //BA.debugLineNum = 542;BA.debugLine="If bmp.Width / bmp.Height > Imv.Width / Imv.Heigh";
if (_bmp.getWidth()/(double)_bmp.getHeight()>_imv.getWidth()/(double)_imv.getHeight()) { 
 //BA.debugLineNum = 543;BA.debugLine="delta = (Imv.Height - bmp.Height / bmp.Width * I";
_delta = (int) ((_imv.getHeight()-_bmp.getHeight()/(double)_bmp.getWidth()*_imv.getWidth())/(double)2);
 //BA.debugLineNum = 544;BA.debugLine="rectDest.Initialize(0, delta,Imv.Width, Imv.Heig";
_rectdest.Initialize((int) (0),_delta,_imv.getWidth(),(int) (_imv.getHeight()-_delta));
 }else {
 //BA.debugLineNum = 546;BA.debugLine="delta = (Imv.Width - bmp.Width / bmp.Height * Im";
_delta = (int) ((_imv.getWidth()-_bmp.getWidth()/(double)_bmp.getHeight()*_imv.getHeight())/(double)2);
 //BA.debugLineNum = 547;BA.debugLine="rectDest.Initialize(delta, 0, Imv.Width - delta,";
_rectdest.Initialize(_delta,(int) (0),(int) (_imv.getWidth()-_delta),_imv.getHeight());
 };
 //BA.debugLineNum = 549;BA.debugLine="cvs.DrawBitmap(bmp, Null, rectDest)";
_cvs.DrawBitmap((android.graphics.Bitmap)(_bmp.getObject()),(android.graphics.Rect)(anywheresoftware.b4a.keywords.Common.Null),(android.graphics.Rect)(_rectdest.getObject()));
 //BA.debugLineNum = 550;BA.debugLine="Imv.Invalidate";
_imv.Invalidate();
...
anywheresoftware.b4a.objects.ConcreteViewWrapper _v = null;
 //BA.debugLineNum = 998;BA.debugLine="Sub GetViewByTag(Parent As Panel,Tag As String) As";
 //BA.debugLineNum = 999;BA.debugLine="For Each v As View In Parent.GetAllViewsRecursive";
...
_v = (anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(group1.Get(index1)));
 //BA.debugLineNum = 1000;BA.debugLine="If v.Tag == Tag Then Return v";
...
int[] _clrs = null;
 //BA.debugLineNum = 27;BA.debugLine="Sub Gradiant As GradientDrawable";
 //BA.debugLineNum = 28;BA.debugLine="Dim Gradient1 As GradientDrawable";
_gradient1 = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 29;BA.debugLine="Dim Clrs(2) As Int";
_clrs = new int[(int) (2)];
;
 //BA.debugLineNum = 30;BA.debugLine="Clrs(0) = 0x9EE5EF7B";
_clrs[(int) (0)] = (int) (0x9ee5ef7b);
 //BA.debugLineNum = 31;BA.debugLine="Clrs(1) = 0x9EA1B300";
_clrs[(int) (1)] = (int) (0x9ea1b300);
 //BA.debugLineNum = 32;BA.debugLine="Gradient1.Initialize(\"TR_BL\", Clrs)";
_gradient1.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TR_BL"),_clrs);
 //BA.debugLineNum = 33;BA.debugLine="Return Gradient1";
if (true) return _gradient1;
 //BA.debugLineNum = 34;BA.debugLine="End Sub";
return null;
}
public static String  _inventory(anywheresoftware.b4a.BA _ba,String _str) throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Sub inventory(str As String)As String";
 //BA.debugLineNum = 159;BA.debugLine="Select str";
switch (BA.switchObjectToInt(_str,"available","comingsoon","unavailable")) {
case 0: {
 //BA.debugLineNum = 161;BA.debugLine="Return \"موجود\"";
if (true) return "موجود";
 break; }
case 1: {
 //BA.debugLineNum = 163;BA.debugLine="Return \"بزودی می‌آید\"";
if (true) return "بزودی می‌آید";
 break; }
case 2: {
 //BA.debugLineNum = 165;BA.debugLine="Return \"ناموجود\"";
...
String _mohasebe_months = "";
 //BA.debugLineNum = 349;BA.debugLine="Sub mohasebe_tarikh(time_time As Long) As String";
 //BA.debugLineNum = 351;BA.debugLine="Dim mohasebe_daghighe As String";
_mohasebe_daghighe = "";
 //BA.debugLineNum = 352;BA.debugLine="mohasebe_daghighe = DateUtils.PeriodBetween(time_";
_mohasebe_daghighe = BA.NumberToString(mostCurrent._dateutils._periodbetween(_ba,_time_time,anywheresoftware.b4a.keywords.Common.DateTime.getNow()).Minutes);
 //BA.debugLineNum = 354;BA.debugLine="Dim mohasebe_saat As String";
_mohasebe_saat = "";
 //BA.debugLineNum = 355;BA.debugLine="mohasebe_saat = DateUtils.PeriodBetween(time_time";
_mohasebe_saat = BA.NumberToString(mostCurrent._dateutils._periodbetween(_ba,_time_time,anywheresoftware.b4a.keywords.Common.DateTime.getNow()).Hours);
 //BA.debugLineNum = 360;BA.debugLine="Dim mohasebe_rooz As String";
_mohasebe_rooz = "";
 //BA.debugLineNum = 361;BA.debugLine="mohasebe_rooz = DateUtils.PeriodBetween(time_time";
_mohasebe_rooz = BA.NumberToString(mostCurrent._dateutils._periodbetween(_ba,_time_time,anywheresoftware.b4a.keywords.Common.DateTime.getNow()).Days);
 //BA.debugLineNum = 363;BA.debugLine="Dim mohasebe_Months As String";
_mohasebe_months = "";
 //BA.debugLineNum = 364;BA.debugLine="mohasebe_Months = DateUtils.PeriodBetween(time_ti";
_mohasebe_months = BA.NumberToString(mostCurrent._dateutils._periodbetween(_ba,_time_time,anywheresoftware.b4a.keywords.Common.DateTime.getNow()).Months);
 //BA.debugLineNum = 367;BA.debugLine="If mohasebe_Months > 1 Then";
if ((double)(Double.parseDouble(_mohasebe_months))>1) { 
 //BA.debugLineNum = 368;BA.debugLine="Return mohasebe_Months &\" ماه و \"&mohasebe_rooz&";
if (true) return _mohasebe_months+" ماه و "+_mohasebe_rooz+" روز پیش ";
 }else if((double)(Double.parseDouble(_mohasebe_rooz))>1) { 
 //BA.debugLineNum = 370;BA.debugLine="Return mohasebe_rooz&\" روز پیش \"";
if (true) return _mohasebe_rooz+" روز پیش ";
 }else if((double)(Double.parseDouble(_mohasebe_saat))>1) { 
 //BA.debugLineNum = 372;BA.debugLine="Return mohasebe_saat & \" ساعت پیش \"";
if (true) return _mohasebe_saat+" ساعت پیش ";
 }else {
 //BA.debugLineNum = 374;BA.debugLine="Return mohasebe_daghighe & \" دقیقه پیش \"";
...
int _adadesh = 0;
 //BA.debugLineNum = 169;BA.debugLine="Sub ParseInt(in1 As String) As Int";
 //BA.debugLineNum = 170;BA.debugLine="If in1 == Null Or in1 == \"null\" Or in1 == \"\" Then";
if (_in1== null || (_in1).equals("null") || (_in1).equals("")) { 
_in1 = BA.NumberToString(0);};
 //BA.debugLineNum = 171;BA.debugLine="If in1.Contains(\".\") Then";
if (_in1.contains(".")) { 
 //BA.debugLineNum = 172;BA.debugLine="in1 = in1.SubString2(0,in1.IndexOf(\".\"))";
_in1 = _in1.substring((int) (0),_in1.indexOf("."));
 };
 //BA.debugLineNum = 174;BA.debugLine="Dim Adadesh As Int";
_adadesh = 0;
 //BA.debugLineNum = 175;BA.debugLine="Adadesh = Bit.ParseInt(in1,10)";
_adadesh = anywheresoftware.b4a.keywords.Common.Bit.ParseInt(_in1,(int) (10));
 //BA.debugLineNum = 176;BA.debugLine="Return Adadesh";
...
_fontbold = (anywheresoftware.b4a.keywords.constants.TypefaceWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.keywords.constants.TypefaceWrapper(), (android.graphics.Typeface)(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("Samim-Bold-FD-WOL.ttf")));
 //BA.debugLineNum = 8;BA.debugLine="Dim SiteUrl As String = \"http://peyjoor.com/\"";
_siteurl = "http://peyjoor.com/";
 //BA.debugLineNum = 9;BA.debugLine="Dim JsonUrl As String = SiteUrl&\"json/\"";
_jsonurl = _siteurl+"json/";
 //BA.debugLineNum = 11;BA.debugLine="Dim P As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 12;BA.debugLine="Dim Debug As Boolean = False";
...
_pi = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 15;BA.debugLine="Dim Intent As Intent";
_intent = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Dim JO As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 17;BA.debugLine="Dim MaterialActionBarHeight,StatusBarHeight As In";
_materialactionbarheight = 0;
_statusbarheight = 0;
 //BA.debugLineNum = 18;BA.debugLine="Dim ActivePage As String = \"\"";
_activepage = "";
 //BA.debugLineNum = 19;BA.debugLine="Dim Color 		As Int";
_color = 0;
 //BA.debugLineNum = 20;BA.debugLine="Dim ColorDark 	As Int";
_colordark = 0;
 //BA.debugLineNum = 21;BA.debugLine="Dim ColorLight 	As Int = 0xFFEFD7AD";
_colorlight = (int) (0xffefd7ad);
 //BA.debugLineNum = 22;BA.debugLine="Dim ColorLightTransparent As Int = 0xDDEFD7AD";
_colorlighttransparent = (int) (0xddefd7ad);
 //BA.debugLineNum = 23;BA.debugLine="Dim ColorAccent As Int";
_coloraccent = 0;
 //BA.debugLineNum = 25;BA.debugLine="End Sub";
return "";
}
public static String  _replace0with98(anywheresoftware.b4a.BA _ba,String _tel) throws Exception{
 //BA.debugLineNum = 208;BA.debugLine="Sub Replace0With98(tel As String) As String";
 //BA.debugLineNum = 209;BA.debugLine="If tel.StartsWith(\"98\") Then";
if (_tel.startsWith("98")) { 
 //BA.debugLineNum = 210;BA.debugLine="Log(\"09\"&tel.SubString2(1,tel.Length))";
anywheresoftware.b4a.keywords.Common.LogImpl("62228226","09"+_tel.substring((int) (1),_tel.length()),0);
 //BA.debugLineNum = 211;BA.debugLine="Return \"09\"&tel.SubString2(1,tel.Length)";
if (true) return "09"+_tel.substring((int) (1),_tel.length());
 }else {
 //BA.debugLineNum = 213;BA.debugLine="Return tel";
if (true) return _tel;
 };
...
public static String  _senoghte(anywheresoftware.b4a.BA _ba,int _adad) throws Exception{
 //BA.debugLineNum = 154;BA.debugLine="Sub SeNoghte(adad As Int)As String";
 //BA.debugLineNum = 155;BA.debugLine="Return NumberFormat2( adad,3,0, 0,True)";
...
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 611;BA.debugLine="Dim package As String";
_package = "";
 //BA.debugLineNum = 612;BA.debugLine="Dim In, out As Int";
_in = 0;
_out = 0;
...
public static String  _setcornerradii(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,float _rx_topleft,float _ry_topleft,float _rx_topright,float _ry_topright,float _rx_bottomright,float _ry_bottomright,float _rx_bottomleft,float _ry_bottomleft) throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Sub SetCornerRadii(v As View, Rx_TopLeft As Float,";
 //BA.debugLineNum = 148;BA.debugLine="Dim JO As JavaObject = v.Background";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_v.getBackground()));
 //BA.debugLineNum = 149;BA.debugLine="If v.Background Is ColorDrawable Or v.Background";
if (_v.getBackground() instanceof android.graphics.drawable.Drawable || _v.getBackground() instanceof android.graphics.drawable.GradientDrawable) { 
 //BA.debugLineNum = 150;BA.debugLine="JO.RunMethod(\"setCornerRadii\", Array As Object(A";
...
anywheresoftware.b4a.phone.Phone _sdk = null;
 //BA.debugLineNum = 988;BA.debugLine="Sub SetElevation (b As View ,f As Float)";
 //BA.debugLineNum = 989;BA.debugLine="Dim sdk As Phone";
_sdk = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 990;BA.debugLine="Dim JO As JavaObject = b";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_b.getObject()));
 //BA.debugLineNum = 991;BA.debugLine="If sdk.SdkVersion > 20 Then";
if (_sdk.getSdkVersion()>20) { 
 //BA.debugLineNum = 992;BA.debugLine="JO.RunMethod(\"setElevation\",Array As Object(f))";
_jo.RunMethod("setElevation",new Object[]{(Object)(_f)});
 //BA.debugLineNum = 993;BA.debugLine="JO.RunMethod(\"setStateListAnimator\", Array(Null)";
...
anywheresoftware.b4j.object.JavaObject _j = null;
 //BA.debugLineNum = 982;BA.debugLine="Sub SetErrorEditText(ET As EditText,text As String";
 //BA.debugLineNum = 983;BA.debugLine="Dim j As JavaObject";
_j = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 984;BA.debugLine="j=ET";
_j = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_et.getObject()));
 //BA.debugLineNum = 985;BA.debugLine="j.RunMethod(\"setError\",Array(text))";
...
anywheresoftware.b4j.object.JavaObject _j = null;
 //BA.debugLineNum = 524;BA.debugLine="Sub SetNavigationBarColor(Clr As Int)";
 //BA.debugLineNum = 526;BA.debugLine="Dim j As JavaObject";
_j = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 527;BA.debugLine="J.InitializeStatic(\"android.os.Build$VERSION\")";
_j.InitializeStatic("android.os.Build$VERSION");
 //BA.debugLineNum = 528;BA.debugLine="If j.GetField(\"SDK_INT\") > 20 Then";
if ((double)(BA.ObjectToNumber(_j.GetField("SDK_INT")))>20) { 
 //BA.debugLineNum = 529;BA.debugLine="J.InitializeContext.RunMethodJO(\"getWindow\",Null";
...
anywheresoftware.b4j.object.JavaObject _window = null;
 //BA.debugLineNum = 509;BA.debugLine="Sub SetStatusBarColor(clr As Int)";
 //BA.debugLineNum = 511;BA.debugLine="If p.SdkVersion >= 21 Then";
if (_p.getSdkVersion()>=21) { 
 //BA.debugLineNum = 512;BA.debugLine="Dim JO As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 513;BA.debugLine="JO.InitializeContext";
_jo.InitializeContext((_ba.processBA == null ? _ba : _ba.processBA));
 //BA.debugLineNum = 514;BA.debugLine="Dim window As JavaObject = JO.RunMethodJO(\"getWi";
_window = new anywheresoftware.b4j.object.JavaObject();
_window = _jo.RunMethodJO("getWindow",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 515;BA.debugLine="window.RunMethod(\"addFlags\", Array (0x80000000))";
_window.RunMethod("addFlags",new Object[]{(Object)(0x80000000)});
 //BA.debugLineNum = 516;BA.debugLine="window.RunMethod(\"clearFlags\", Array (0x04000000";
_window.RunMethod("clearFlags",new Object[]{(Object)(0x04000000)});
 //BA.debugLineNum = 517;BA.debugLine="window.RunMethod(\"setStatusBarColor\", Array(clr)";
_window.RunMethod("setStatusBarColor",new Object[]{(Object)(_clr)});
 };
 //BA.debugLineNum = 520;BA.debugLine="SetNavigationBarColor(clr)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _ref = null;
 //BA.debugLineNum = 570;BA.debugLine="Sub SetTextShadow(pView As View, pRadius As Float,";
 //BA.debugLineNum = 571;BA.debugLine="Dim ref As Reflector";
_ref = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 572;BA.debugLine="ref.Target = pView";
_ref.Target = (Object)(_pview.getObject());
 //BA.debugLineNum = 573;BA.debugLine="ref.RunMethod4(\"setShadowLayer\", Array As Object(";
...
anywheresoftware.b4a.object.XmlLayoutBuilder _xml1 = null;
 //BA.debugLineNum = 36;BA.debugLine="Sub SetToolbarStyle(toolbar As ACToolBarLight,Tool";
 //BA.debugLineNum = 38;BA.debugLine="If MaterialActionBarHeight == 0 Then";
if (_materialactionbarheight==0) { 
 //BA.debugLineNum = 39;BA.debugLine="ToastMessageShow(CSB(\"خطا | مجددا وارد شوید\"),Tr";
...
anywheresoftware.b4a.keywords.Common.ExitApplication();
 ...
 //BA.debugLineNum = 43;BA.debugLine="toolbar.SetBackgroundImage(LoadBitmapResize(File.";
_toolbar.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"toolbar.jpg",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (313),_ba),(int) (_materialactionbarheight+(_statusbarheight*1.5)),anywheresoftware.b4a.keywords.Common.False).getObject()));
 //BA.debugLineNum = 44;BA.debugLine="toolbar.Title=CSBTitle(ToolbarTitle)";
_toolbar.setTitle(BA.ObjectToCharSequence(_csbtitle(_ba,_toolbartitle).getObject()));
 //BA.debugLineNum = 45;BA.debugLine="toolbar.TitleTextColor=Colors.White";
_toolbar.setTitleTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 46;BA.debugLine="toolbar.Padding=Array As Int(0,StatusBarHeight,0,";
_toolbar.setPadding(new int[]{(int) (0),_statusbarheight,(int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0))});
 //BA.debugLineNum = 47;BA.debugLine="toolbar.Height=MaterialActionBarHeight+(StatusBar";
_toolbar.setHeight((int) (_materialactionbarheight+(_statusbarheight*1.5)));
 //BA.debugLineNum = 49;BA.debugLine="If HasBackBtn Then";
if (_hasbackbtn) { 
 //BA.debugLineNum = 50;BA.debugLine="Dim XML1 As XmlLayoutBuilder";
_xml1 = new anywheresoftware.b4a.object.XmlLayoutBuilder();
 //BA.debugLineNum = 51;BA.debugLine="toolbar.NavigationIconDrawable = XML1.GetDrawabl";
_toolbar.setNavigationIconDrawable(_xml1.GetDrawable("round_arrow_back_white_24"));
 };
 //BA.debugLineNum = 54;BA.debugLine="NextBox.SetLayout(0,toolbar.Height,100%x,100%y-to";
...
anywheresoftware.b4a.keywords.Regex.MatcherWrapper _matchemail = null;
 //BA.debugLineNum = 555;BA.debugLine="Sub ValidateEmail(EmailAddress As String) As Boole";
 //BA.debugLineNum = 557;BA.debugLine="Dim MatchEmail As Matcher = Regex.Matcher(\"^(?i)[";
...
_matchemail = anywheresoftware.b4a.keywords.Common.Regex.Matcher("^(?i)[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])$",_emailaddress);
 //BA.debugLineNum = 559;BA.debugLine="If MatchEmail.Find = True Then";
if (_matchemail.Find()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 560;BA.debugLine="Log(MatchEmail.Match)";
anywheresoftware.b4a.keywords.Common.LogImpl("62883589",_matchemail.getMatch(),0);
 //BA.debugLineNum = 561;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 563;BA.debugLine="Log(\"Oops, please double check your email addres";
anywheresoftware.b4a.keywords.Common.LogImpl("62883592","Oops, please double check your email address...",0);
