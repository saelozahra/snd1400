...
public class notificationact extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.saelozahra.snd1400", "ir.saelozahra.snd1400.notificationact");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.saelozahra.snd1400", "ir.saelozahra.snd1400.notificationact");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.saelozahra.snd1400.notificationact", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._activity.LoadLayout("SVLayout",mostCurrent.activityBA);
 //BA.debugLineNum = 38;BA.debugLine="SaeloZahra.SetToolbarStyle(ToolBar,\"اطلاعیـــــــ";
mostCurrent._saelozahra._settoolbarstyle /*String*/ (mostCurrent.activityBA,mostCurrent._toolbar,"اطلاعیـــــــــه ها",anywheresoftware.b4a.keywords.Common.True,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._scrollview1.getObject())));
...
anywheresoftware.b4a.keywords.Common.LogImpl("613828103",BA.ObjectToString(_in1.GetExtra("Notification_Tag")),0);
...
_cu1 = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(_sql1.ExecQuery("SELECT * FROM notification ORDER BY id DESC limit 110")));
...
anywheresoftware.b4a.keywords.Common.LogImpl("613762575",_cu1.GetString("id"),0);
...
public static boolean  _matn_overrideurl(String _url) throws Exception{
 ...
 //BA.debugLineNum = 163;BA.debugLine="ProgressDialogShow2(\"چند لحظه صبر کنید\",True)";
...
anywheresoftware.b4a.keywords.Common.LogImpl("614221313","Open Telegram",0);
