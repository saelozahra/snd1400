...
public class singlecandidateact extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.saelozahra.snd1400", "ir.saelozahra.snd1400.singlecandidateact");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.saelozahra.snd1400", "ir.saelozahra.snd1400.singlecandidateact");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.saelozahra.snd1400.singlecandidateact", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String _candidateid = "";
...
public ir.saelozahra.snd1400.httpjob _imagejob = null;
...
anywheresoftware.b4a.keywords.Common.LogImpl("618546690","LVProductSlider: "+BA.NumberToString(_propertynumber)+"   VarName: "+_varname+"   VarValue: "+_varvalue,0);
...
mostCurrent._imagejob = new ir.saelozahra.snd1400.httpjob();
...
public static String  _jobdone(ir.saelozahra.snd1400.httpjob _j) throws Exception{
...
anywheresoftware.b4a.keywords.Common.LogImpl("617956865",_j._jobname /*String*/ +" | "+BA.ObjectToString(_j._success /*boolean*/ ),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617956939",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 break; }
}
;
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 8;BA.debugLine="Dim CandidateID As String";
_candidateid = "";
...
anywheresoftware.b4a.keywords.Common.LogImpl("618677761",BA.NumberToString(_item.getItemId()),0);
